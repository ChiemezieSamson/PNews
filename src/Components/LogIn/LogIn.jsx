...
const LogIn = () => {
  ...
  return (
    <div className={`pb-10 2xl:py-32 pt-3 sm:my-10 md:my-14 lg:my-20 text-left bg-gradient-to-b from-neutral-100 via-gray-50 to-neutral-100 ${isFecthingStyle(isLoading)}`}>
