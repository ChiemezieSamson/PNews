  ...
  return (
    <h2 className="inline-block w-full">
      ...
      <span className="bg-white text-black whitespace-nowrap font-bold font-round text-base sm:text-lg md:text-sm lg:text-lg capitalize">
        ...
        {redletters && <strong className="mainColor px-1.5 pt-px">{redletters}</strong>}
      </span>
    </h2>
  )
}
  ...
  return (
    <h2 className="inline-block w-full relative isolate after:absolute after:inset-0 whitespace-nowrap
      ...
      <span className="bg-white text-black pr-4 font-bold font-josefin text-lg md:text-sm lg:text-lg capitalize">
        ...
        {secondletter && <strong className="mainColor"> { secondletter }</strong>}
      </span>
    </h2>
  )
}
...
export const PagesDivider = ({text}) => {
  ...
  return (
    <div className="bg-white relative pr-4 py-1 my-1 font-bold font-josefin text-lg md:text-sm lg:text-lg capitalize before:absolute before:inset-x-0 before:bottom-0 before:h-0.5 
    before:bg-neutral-200 after:absolute after:left-0 after:bottom-0 after:w-8 after:h-0.5 after:bg-[#f70d28] after:z-10">
              ...
              <ul className="grid grid-flow-col">
                ...
                {CategoriesLinks?.slice(0, 5)?.map((cat) => {
                  ...
                  return (
                    ...
                    <li key={cat?.id} 
                      className={`inline-block cursor-pointer uppercase last:hidden  last:md:inline-block  
...
const SocialMediaCount = ({text, bg, shareUrl, postTitle, postId, SocialSharedCount}) => {
  ...
  return (
    <span className={`relative pr-1.5 ring-0 ${isFecthingStyle(isLoading)}`}>
        ...
        {canOpen && isHovered ?
          ...
          <>
            <SocialMediaCount  
              text={"Share"} 
              bg={"bg-[#45629f]"} 
              shareUrl={`https://pnews-sc7h.onrender.com/single/${postId}`} 
              postTitle={postTitle} 
              postId={postId} 
...
export const isFecthingStyle = (isFetching) => {
  ...
  const isFetchingStyle = `${isFetching && "after:opacity-40 after:bg-white relative after:absolute after:inset-0 after:z-40"}`
