...
import { useHover, useWindowSize} from '../../../SharedAsset/SharedAssets';
        ...
        <div className='md:col-span-2 md:mr-[4%] overflow-x-hidden'>
          ...
          <article>
            ...
            <div className="lg:mb-8 lg:mt-8 mb-4 grid grid-flow-col justify-between text-stone-800">
              <small>Home &gt; single &gt; {postAction && Post?.postCategory[0]}</small>
            ...
            <div className='mt-5 grid grid-flow-col content-center justify-between'>
              ...
              <div className='text-neutral-400'>
                ...
                {/* Admin Image */}
                <Link to={`/categories?user=${userAction && User?._id}`} className="max-w-[40px] max-h-10 inline-block rounded-full align-bottom mr-2">
                  {userAction ?
              ...
              <span className='align-top text-lg sm:mt-0.5 inline-block'>
                ...
                <span className='hidden sm:inline-block'>
                  ...
                  {contentAction ? <span className='mb-0.5 text-[#7a7a7a]/80 leading-4 align-middle inline-block font-medium'>{comments?.length}</span>
                  :
                  <div className='skeleton h-3 w-3 inline-block'></div>}
                </span>
              </span>
            </div>
