...
import { formatDate, isFecthingStyle } from '../../../../SharedAsset/SharedAssets';
import { commentText } from '../../../../SharedAsset/Vaidations/RegularExpression';
import { CommentSpinner } from '../../../../SharedAsset/Spinners/Spinner';

const Comment = ({comments, postId, byUserId, postAuthor, offsetOfForm, contentAction, onAnyIsfetching}) => {
  ...
  return ( 
    <div className="my-2 py-2 bg-neutral-100 rounded-md">
      ...
      <span className='my-4 inline-block'>
        ...
        <span className='inline-block px-3 py-px bg-neutral-400 mx-4 text-neutral-50 rounded-md'>
          {(comments?.length && contentAction) ? comments?.length : 0}
        </span>
