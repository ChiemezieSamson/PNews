...
import { AdminComponent, CategoriesComponent, NavDirectionAndPageName, overLay, TimeComponent } from "../../SharedAsset/SharedAssets";
          ...
          {Posts?.slice(0, 4)?.map((post) => {
            return (
              <li key={post._id} className="md:first:col-start-1 md:first:col-end-4 md:first:row-start-1 md:first:row-end-7 
                ...
                <span className="text-white absolute -top-[7px] left-0 z-30 max-w-fit inset-x-auto">
                ...
                <span className='absolute bottom-0 max-w-fit text-white right-0 z-30 mx-1 backdrop-blur-sm bg-black/10 bg-blend-burn px-px '>
