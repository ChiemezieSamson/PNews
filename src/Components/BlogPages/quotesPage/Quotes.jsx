...
import { SharedBlogPageStyleOne } from "../../ButtonAndOthers/SharedBlogPageStyle_1st_Component";
...
const Quotes = () => {
  ...
  return (
    <section className="text-left">
      ...
      <SharedBlogPageStyleOne Posts={Posts.slice(6, 10)} />
      
      <div className='md:grid md:grid-cols-3'>
        <div className="col-span-2 md:mr-[3%]">
          <NavDirectionAndPageName page={"Books"} />
        
          <PagesBlogPostComponent Posts={Posts.slice(2, 12)} />
        </div>
